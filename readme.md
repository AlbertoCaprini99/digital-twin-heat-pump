...
### 🔬 Experiments
- Over 70 experimental tests under different operating conditions to validate the physical-based model
- Over 35 experimental tests with refrigerant undercharge from 10% to 40%, under different operating conditions.
